...
[![Go Report Card](https://goreportcard.com/badge/github.com/frankegoesdown/bfym)](https://goreportcard.com/report/github.com/frankegoesdown/bfym)
...
Previously Gorsk was built using [Gin](https://github.com/gin-gonic/gin). Gorsk using Gin is available [HERE](https://github.com/frankegoesdown/bfym-gin).
...
1. To use Gorsk as a starting point of a real project whose package name is something like `github.com/author/project`, move the directory `$GOPATH/github.com/frankegoesdown/bfym` to `$GOPATH/github.com/author/project` and do a global replacement of the string `github.com/frankegoesdown/bfym` with `github.com/author/project`.
